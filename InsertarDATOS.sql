...
Insert TDocentes Select 'D0002','VICTOR GABRIEL','JALISTO CAMACHO','','NOMBRADO','','','','M', BulkColumn from Openrowset( Bulk 'F:\UNSAAC\DESARROLLO DE SOFTWARE\A PROYECTO FINAL\2021\2021\2021\imagen8.jpg', Single_Blob) as TDocentes
Insert TDocentes Select 'D0003','ALVARO','MENDOZA ESCALANTE ','','NOMBRADO','','','','M', BulkColumn from Openrowset( Bulk 'F:\UNSAAC\DESARROLLO DE SOFTWARE\A PROYECTO FINAL\2021\2021\2021\imagen8.jpg', Single_Blob) as TDocentes
Insert TDocentes Select 'D0004','MILAGRO CONSTANZA','LOPEZ GUTIERREZ','','NOMBRADO','','','','F', BulkColumn from Openrowset( Bulk 'F:\UNSAAC\DESARROLLO DE SOFTWARE\A PROYECTO FINAL\2021\2021\2021\imagen8.jpg', Single_Blob) as TDocentes
Insert TDocentes Select 'D0005','JOSE ANTONIO','CCENTE OLARTE','','CONTRATADO','','','','M', BulkColumn from Openrowset( Bulk 'F:\UNSAAC\DESARROLLO DE SOFTWARE\A PROYECTO FINAL\2021\2021\2021\imagen8.jpg', Single_Blob) as TDocentes
Insert TDocentes Select 'D0006','JARED','LEON MALPARTIDA','','CONTRATADO','','','','M', BulkColumn from Openrowset( Bulk 'F:\UNSAAC\DESARROLLO DE SOFTWARE\A PROYECTO FINAL\2021\2021\2021\imagen8.jpg', Single_Blob) as TDocentes
Insert TDocentes Select 'D0007','FABIOLA','ROZAS FLORES','','CONTRATADO','','','','F', BulkColumn from Openrowset( Bulk 'F:\UNSAAC\DESARROLLO DE SOFTWARE\A PROYECTO FINAL\2021\2021\2021\imagen8.jpg', Single_Blob) as TDocentes
Insert TDocentes Select 'D0008','ANGELA','MENDOZA VILLALOBOS','','CONTRATADO','','','','F', BulkColumn from Openrowset( Bulk 'F:\UNSAAC\DESARROLLO DE SOFTWARE\A PROYECTO FINAL\2021\2021\2021\imagen8.jpg', Single_Blob) as TDocentes
Insert TDocentes Select 'D0009','MARGOT','HUANCA QUISPE','','CONTRATADO','','','','F', BulkColumn from Openrowset( Bulk 'F:\UNSAAC\DESARROLLO DE SOFTWARE\A PROYECTO FINAL\2021\2021\2021\imagen8.jpg', Single_Blob) as TDocentes
Insert TDocentes Select 'D0010','RUTH DANIELLA','MUJICA DEL CARPIO','','CONTRATADO','','','','F', BulkColumn from Openrowset( Bulk 'F:\UNSAAC\DESARROLLO DE SOFTWARE\A PROYECTO FINAL\2021\2021\2021\imagen8.jpg', Single_Blob) as TDocentes
Insert TDocentes Select 'D0011','VELA','CANDIA','Crepúsculo.','CONTRATADO','','','','M', BulkColumn from Openrowset( Bulk 'F:\UNSAAC\DESARROLLO DE SOFTWARE\A PROYECTO FINAL\2021\2021\2021\imagen8.jpg', Single_Blob) as TDocentes
Insert TDocentes Select 'D0012','BELARMINO','CANDIA HUANACO','','CONTRATADO','','','','M', BulkColumn from Openrowset( Bulk 'F:\UNSAAC\DESARROLLO DE SOFTWARE\A PROYECTO FINAL\2021\2021\2021\imagen8.jpg', Single_Blob) as TDocentes
Insert TDocentes Select 'D0013','PAUL ALONSO','PINELO ESCALANTE','','CONTRATADO','','','','M', BulkColumn from Openrowset( Bulk 'F:\UNSAAC\DESARROLLO DE SOFTWARE\A PROYECTO FINAL\2021\2021\2021\imagen8.jpg', Single_Blob) as TDocentes
Insert TDocentes Select 'D0014','SILVIA LUCIANA','JORDAN RAMOS','','CONTRATADO','','','','F', BulkColumn from Openrowset( Bulk 'F:\UNSAAC\DESARROLLO DE SOFTWARE\A PROYECTO FINAL\2021\2021\2021\imagen8.jpg', Single_Blob) as TDocentes

SELECT *
FROM TDocentes

delete from TDocentes where Codigo_Docente like 'CCI1'
...
go
insert into Detalle_Pago Values('DP020',250.0,'Caja Cusco','Sin Observaciones')
insert into Detalle_Pago Values('DP021',250.0,'VISA','Sin Observaciones')
insert into Detalle_Pago Values('DP022',250.0,'Caja Cusco','Sin Observaciones')
...
insert into Pago Values('P001','00024','10104','DP020')
